...
public class Reducer1 extends MapReduceBase implements Reducer<Text, Text, Text, Text>{
    ...
    @Override
    public void reduce(Text year, Iterator<Text> tagName, OutputCollector<Text,Text> output, Reporter rprtr) throws IOException {
        ...
        while(iterator.hasNext()) {
         ...
         output.collect(new Text(count+","+year+","+s), new Text());
      }
